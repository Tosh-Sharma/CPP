...
int main(int argc, char* argv[]) {
    ...
    std::cout << std::endl;
    std::cout << "Time used by merge-insert sort with std::vector: " << duration_vec.count() << " seconds" << std::endl;
    ...
    std::cout << "Time used by merge-insert sort with std::deque: " << duration_deq.count() << " seconds" << std::endl;
